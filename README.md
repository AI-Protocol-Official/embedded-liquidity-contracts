# AI Protocol Embedded Liquity Contracts #
Contains the logic for embedded liquidity of DPT's
...
* Smart Contract(s):
    * [ETHShares](contracts/bonding_curves/ETHShares.sol) – ETHShares implementation
    * [ERC20Shares](contracts/bonding_curves/ERC20Shares.sol) – ERC20Shares implementation
